    ...
    <body>
       <div class="container"> 
        <div class="jumbotron">
            ...
            <p>More info</p>
            <p class="lead">
                <a class="btn btn-primary btn-lg" href="Jumbo action link" role="button">Here</a>
            </p>
         </div>
         <div class="row">
            <div class="col bg-danger text-white">Kolom 1</div>
            <div class="col bg-warning">Kolom 2</div>
            <div class="col bg-primary text-white">Kolom 3</div>
         </div>
         <div class="row">
            ...
            <div class="col-2 bg-primary text-white">Kolom 3</div>
         </div>
        </div>
    </body>
</html>
...
<link href="https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,200..800;1,200..800&family=Merriweather:ital,wght@0,300;0,400;0,700;0,900;1,300;1,400;1,700;1,900&family=Oswald:wght@200..700&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="mycsswan.css">
...
<a href="#">Halaman ini</a>
    <h3 style="color: rgb(27, 0, 86);">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</h3>
    <p><i>Oleh : itsash |  23 | Source : ITS Online</i></p>
    <p>
        <img src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_084851-1024x576.jpg"width=580>
        <br>
        <font size=3>Suasana Kuliah Umum Mentoring Agama Islam Semester Genap 2024/2025</font>
    </p>
    <p>
